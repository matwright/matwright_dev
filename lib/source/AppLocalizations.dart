...
class AppLocalizations {
  ...
  static Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'aboutDescription':"Thanks for taking the time to visit my homepage. I have been working in the field of app design and development since 2004. That era(~2005) coincided with the release of PHP5 and I decided to use it, along with MySQL and the rest of the LAMP ecosystem going. I went on to become a Zend Certified PHP Engineer in 2008 and to work on a variety of custom PHP and Zend Framework web apps for businesses in the UK and Europe as well as remote clients in Canada and the US.\n\nI have been lucky enough to work with some amazing startups, well known brands and even a couple of TV celebrities along the way!\nIn 2012 I became an employer and provided opportunities for trainees and internships at a local university.\n\nOver the last few of years I have become increasingly interested in portable apps and immersive technologies; especially from a creative perspective. I now spent much of my time researching and developing apps for portable devices aswell as virtual and mixed-reality platforms.\n\nMy research interests include gamification, the ethics of app design and development and social interactivity through technology.\n\nIf you would like to discuss a commercial or research based project for mobile or XR, get in touch."
    },
    'fr': {
      'home':'Accueil',
      'submit':'Envoyer',
      ...
      'research':'Recherche',
      'popupTitle':'Hé, merci d\'être passé !',
      ...
      'contactAR':'Mixed/Augmented Reality',
      'contactWearable':'Wearable/IoT',
      'homeTitle': 'Création d\'Applications‎',
      'homeDescription': 'Hi, I create apps for a variety of platforms including web, mobile & XR. ',
      'aboutTitle': 'A Propos',
      'aboutHeading':'Mat Wright',
